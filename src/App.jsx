...
[도매상 상호명 추출 - 매우 중요]:
명세서 왼쪽 공급자 칸의 "상호" 항목만 읽으세요. 주소/지역명/구청명 절대 금지.
- "지오영네트웍스" 또는 "지오영" → "지오영"
- "복산나이스 서울지점" → "복산나이스" (지점명 제외)
- "(주)신덕팜" → "신덕팜"
- "백제약품(주) 영등포지점" → "백제약품" (지점명 제외)
- "(주)케이에스팜" → "KS팜"
...
- 글자 혼동 주의: 넥↔벽, 시↔씨, 레↔데, 젯↔셋, 로↔보, 캡↔갭, 틴↔팀

[보험코드]:
- 9자리 숫자 (예: 643304110, 050100020)
- 모든 약품에 반드시 있으니 빠짐없이 추출
- 없으면 빈 문자열
